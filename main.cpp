...
int main()
{
  ...
  pricing_engine::models::MonteCarloModel monte_carlo_engine(10000, 10000);
  double bsm_price = bsm_engine.price(option, market_data);
  double binomial_price = binomial_engine.price(option, market_data);
  double monte_carlo_price = monte_carlo_engine.price(option, market_data);
  ...
  cout << "Binomial delta: " << binomial_engine.delta(option, market_data) << endl;
  cout << "Monte Carlo delta: " << monte_carlo_engine.delta(option, market_data) << endl;
  cout << "Option gamma: " << bsm_engine.gamma(option, market_data) << endl;
  cout << "Binomial gamma: " << binomial_engine.gamma(option, market_data) << endl;
  cout << "Monte Carlo gamma: " << monte_carlo_engine.gamma(option, market_data) << endl;
  cout << "Option vega: " << bsm_engine.vega(option, market_data) << endl;
  cout << "Binomial vega: " << binomial_engine.vega(option, market_data) << endl;
  cout << "Monte Carlo vega: " << monte_carlo_engine.vega(option, market_data) << endl;
  cout << "Option theta: " << bsm_engine.theta(option, market_data) << endl;
  cout << "Binomial theta: " << binomial_engine.theta(option, market_data) << endl;
  cout << "Monte Carlo theta: " << monte_carlo_engine.theta(option, market_data) << endl;
  cout << "Option rho: " << bsm_engine.rho(option, market_data) << endl;
  cout << "Binomial rho: " << binomial_engine.rho(option, market_data) << endl;
  cout << "Monte Carlo rho: " << monte_carlo_engine.rho(option, market_data) << endl;
